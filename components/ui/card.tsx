...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "w-[100%] h-[100%] flex flex-col justify-center items-center rounded-xl bg-black text-slate-950 shadow dark:border-slate-800 dark:bg-slate-950 dark:text-slate-50",
      className
    )}
    {...props}
  />
