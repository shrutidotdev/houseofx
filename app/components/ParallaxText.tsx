...
export function ParallaxText({ children, baseVelocity = 100, className, style }: ParallaxTextProps) {
  const baseX = useMotionValue(0);
  const scrollVelocity = useVelocity(useMotionValue(window.scrollY));
